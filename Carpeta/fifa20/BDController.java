...
public class BDController {
	...
	public BDController() {
		try {
			...
			this.miConexion=DriverManager.getConnection("jdbc:mysql://localhost:3306/fifa20","root","");
	...
	public int contarJugadores() {
		...
		try {
			Statement miStatement = this.miConexion.createStatement();
			ResultSet rs = miStatement.executeQuery("SELECT COUNT(nombre)AS Cantidad FROM jugadores;");
