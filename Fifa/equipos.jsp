								...
								<table class="alt">
									...
									<%for (int i=0; i<equipos.size(); i++) { %>
										<tr>
											...
											<td width='300' colspan="3" style="padding-left: 15px;"><a href="equipo.jsp?cod_equipo=<%=equipos.get(i).getCod_equipo() %>"><%=equipos.get(i).getNombre() %></a></td>
											<%
											ArrayList<Jugador> jugadores = controladorBD.dameJugadoresEquipo(equipos.get(i).getCod_equipo());
											for (int j=0; j<jugadores.size(); j++) { %>
											<td rowspan="2" width='60' style="text-align: center;"><a href="jugador.jsp?cod_jugador=<%=jugadores.get(j).getCod_jugador() %>">
											<img title='<%=jugadores.get(j).getNombre() %>' width='45px' src="images/jugadores/<%=jugadores.get(j).getCod_jugador() %>.png" />
											</a></td>	
											<%} %>									
										</tr>
										<tr>
										  
										  <td width='50' style="text-align: left; padding-left: 14px;"><a href="liga.jsp?cod_liga=<%=equipos.get(i).getCod_liga() %>"><img src="images/ligas/<%=equipos.get(i).getCod_liga() %>.png" width=40 /></a></td>
										  <td width='50' style="text-align: left; padding-left: 14px;"><img src="images/paises/<%=controladorBD.damePaisLiga(equipos.get(i).getCod_liga()) %>.png" width=40 /></td>
										  <td width='50' style="text-align: left; padding-left: 14px;"></td>
										</tr>
									<%} %>
