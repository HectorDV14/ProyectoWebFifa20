					...
					<div class="container">
						<div id="content">
							...
							<!-- Content -->
								...
								<h3>Alta Jugador</h3>
								<form action="operaciones_alu.jsp?action=AltaJugador&&" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del jugador" style="width:450px"; maxlength="20"/>
										</div>
										<div class="">
											<input type="text" name="pierna" id="pierna" placeholder="Pierna buena" maxlength="9"/>
										</div>
										<div class="">
											<input type="number" name="altura" id="altura" placeholder="Altura en cm" maxlength="3"/>
										</div>
										<div class="">
											<input type="text" name="nacionalidad" id="nacionalidad" placeholder="nacionalidad" maxlength="20"/>
										</div>
										<div class="">
											<input type="number" name="cod_equipo" id="cod_equipo" placeholder="Codigo del equipo" maxlength="4"/>
										</div>
